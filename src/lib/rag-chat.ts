...
const CANNED: Record<string, string> = {
  "كيف أوفر في فاتورة الكهرباء؟":
    "بناءً على KAPSARC/KBEAT وSERA:\n\n• قلّل مدة تشغيل المكيف والمساحة المبردة\n• استخدم مكيفاً عالي الكفاءة (SASO 2663)\n• عزل حراري وإضاءة LED\n• شغّل الأجهزة الثقيلة في ساعات الليل\n\nنصائح نوعية — ليست ضمان توفير محدد.",
