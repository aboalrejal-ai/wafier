        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginBottom: 20 }}>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 20 }}>
              <div style={{ textAlign: "start" }}>
                ...
                <div style={{ display: "flex", alignItems: "baseline", gap: 6, justifyContent: "flex-start" }}>
                  <span style={{ fontSize: 44, fontWeight: 800, color: "#fff", letterSpacing: "-1.5px" }} dir="ltr">{budget}</span>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              {[
                { label: t("dashboard.remaining"), value: remaining.toFixed(2), icon: "💳" },
                { label: t("dashboard.currentSpend"), value: spend.toFixed(2), icon: "📉" },
              ].map((s) => (
                <div key={s.label} style={{ background: "rgba(255,255,255,0.1)", borderRadius: 12, padding: "14px 16px", textAlign: "start" }}>
                  ...
                  <div style={{ fontSize: 20, fontWeight: 800, color: "#fff" }} dir="ltr">{s.value} <span style={{ fontSize: 12, fontWeight: 400 }}>{t("common.sar")}</span></div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            {[
              ...
              { icon: "⚡", label: t("dashboard.energyUse"), value: `${(spend / Math.max(budget, 1)).toFixed(2)} kW`, sub: "" },
              { icon: "🌤️", label: t("dashboard.weatherStatus"), value: "", sub: weather.description },
            ].map((item, i) => (
              <div key={i} style={{ background: "#fff", borderRadius: 14, padding: "18px 16px", border: "1px solid #E5E7EB", boxShadow: "0 1px 3px 0 hsl(220 39% 11% / .10), 0 1px 2px 0 hsl(220 39% 11% / .06)", textAlign: "start" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
          ...
          <div style={{ background: "#fff", borderRadius: 18, padding: "24px", border: "1px solid #E5E7EB", boxShadow: "0 1px 3px 0 hsl(220 39% 11% / .10), 0 1px 2px 0 hsl(220 39% 11% / .06)", display: "flex", flexDirection: "column" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
              <h2 style={{ margin: 0, fontSize: 16, fontWeight: 700, color: "hsl(var(--color-gray-900))" }}>{t("dashboard.billForecast")} 💡</h2>
            ...
            <div style={{ background: "hsl(var(--color-sa-25))", borderRadius: 12, padding: "16px 20px", marginBottom: 16, textAlign: "start", border: "1px solid hsl(var(--color-sa-100))" }}>
              ...
              <p style={{ margin: 0, fontSize: 28, fontWeight: 800, color: "hsl(var(--color-sa-700))" }} dir="ltr">{forecast.toFixed(2)} <span style={{ fontSize: 14 }}>{t("common.sar")}</span></p>
